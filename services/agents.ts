...
export const AGENT_FAMILY: Agent[] = [
  {
    name: "Andoy",
    gender: "Male",
    role: "King / Founder",
  ...
  },
  {
    ...
    skills: ["Dashboards", "Data Science", "Metrics", "Web Research"],
  ...
  },
  {
    ...
    skills: ["AI Synthesis", "Emotional Intelligence", "Conversation", "Harmony", "Documentation"],
...
export const getAgent = (name: string): Agent | undefined => {
    return AGENT_FAMILY.find(agent => agent.name.toLowerCase() === name.toLowerCase());
}